<x-app-layout>
    ...
    <div class="flex">
        <div class="relative flex flex-col bg-clip-border  bg-[#1f2937] text-white h-[calc(101.5vh-5rem)] w-full max-w-[18rem] p-4 shadow-xl shadow-blue-gray-900/5" style="background: #77472B;">
            <div class="mb-2 p-4">
            ...
            <nav class="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-white">
                <a href="{{ url('/') }}" class="flex items-center w-full p-2 py-5 rounded-lg text-start leading-tight transition-all @if (Request::is('/')) bg-blue-50 bg-opacity-80 text-blue-900 @else hover:bg-blue-50 hover:bg-opacity-80 hover:text-blue-900 @endif focus:bg-blue-50 focus:bg-opacity-80 focus:text-blue-900 active:bg-gray-50 active:bg-opacity-80 active:text-blue-900 outline-none">
                    <div class="grid place-items-center mr-4">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" width="25px" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{ route('administracion.usuarios') }}" class="flex items-center w-full p-2 py-5 rounded-lg text-start leading-tight transition-all @if (Request::is('administracion')) bg-blue-50 bg-opacity-80 text-blue-900 @else hover:bg-blue-50 hover:bg-opacity-80 hover:text-blue-900 @endif focus:bg-blue-50 focus:bg-opacity-80 focus:text-blue-900 active:bg-gray-50 active:bg-opacity-80 active:text-blue-900 outline-none">
                    <div class="grid place-items-center mr-4">
                        <svg fill="currentColor" stroke-width="0" viewBox="0 0 24 24" width="25px" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{route('ventas.ventas')}}">
                    <div role="button" tabindex="0" class="flex items-center w-full p-2 py-5 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                        <div class="grid place-items-center mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" width="25px">
                        ...
                        </div>Ventas<div class="grid place-items-center ml-auto justify-self-end">
                        </div>
                    </div>
                </a>
                <a href="{{route('fabrica.main')}}">
                    <div role="button" tabindex="0" class="flex items-center w-full p-2 py-5 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                        <div class="grid place-items-center mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" width="25px">
                                <path fill-rule="evenodd" d="M6.912 3a3 3 0 00-2.868 2.118l-2.411 7.838a3 3 0 00-.133.882V18a3 3 0 003 3h15a3 3 0 003-3v-4.162c0-.299-.045-.596-.133-.882l-2.412-7.838A3 3 0 0017.088 3H6.912zm13.823 9.75l-2.213-7.191A1.5 1.5 0 0017.088 4.5H6.912a1.5 1.5 0 00-1.434 1.059L3.265 12.75H6.11a3 3 0 012.684 1.658l.256.513a1.5 1.5 0 001.342.829h3.218a1.5 1.5 0 001.342-.83l.256-.512a3 3 0 012.684-1.658h2.844z" clip-rule="evenodd"></path>
                            </svg>
                        </div>Fabrica<div class="grid place-items-center ml-auto justify-self-end">
                        </div>
                    </div>
                </a>
                <div role="button" tabindex="0" class="flex items-center w-full p-2 py-5 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
