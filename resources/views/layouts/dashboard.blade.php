<x-app-layout>
    ...
    <div class="flex">
        <div class="relative flex flex-col bg-clip-border  bg-[#1f2937] text-white h-[calc(101.5vh-5rem)] w-full max-w-[18rem] p-4 shadow-xl shadow-blue-gray-900/5"
            ...
            <nav class="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-white">
                <div role="button" tabindex="0"
                    class="flex items-center w-full p-2 py-5 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-gray-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                ...
                <div role="button" tabindex="0"
                    class="flex items-center w-full p-2 py-5 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                    <div class="grid place-items-center mr-4">
