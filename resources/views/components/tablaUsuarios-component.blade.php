      ...
      <tbody class="divide-y divide-gray-100 border-t border-gray-100">
        ...
        <tr class="hover:bg-gray-50">
          <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
            ...
            <div class="text-sm">
              <div class="font-medium text-gray-700">{{ $usuario->nombre ." ". $usuario->apellidos }}</div>
          ...
          <td class="px-6 py-4">
            <div class="flex justify-end gap-4">
              <button onclick="modalHandler(true)"  id="" href="#">
                <svg
              ...
              <a  id="" href="{{ route('administracion.editar', $usuario->id_empleado) }}">
